...
using FlavourVault.NotificationsService;
using FlavourVault.SharedCore.CommonProviders;
...
services.AddScoped<ISecretProvider, AzureSecretProvider>();
...
services.AddSingleton<IMessageBusDispatcher, RabbitMQDispatcher>();
...
services.AddNotificationServices(builder.Configuration, assemblies);
